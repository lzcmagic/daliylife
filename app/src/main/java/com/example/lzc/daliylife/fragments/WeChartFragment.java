...
import com.example.lzc.daliylife.activity.WeChartDetailInfo;
...
public class WeChartFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mAdapter.setOnitemClickListener(new OnRecyclerViewItemClickListener() {
            ...
            public void onItemClick(RecyclerView.ViewHolder holder, int position) {
                ...
                WeChartDetailInfo.actionIntentStart(getActivity(),
                        result.getTitle(),
                        result.getSource(),
                        result.getUrl());
            }
    ...
    private void initData() {
        HttpMethods.getInstance(Constants.WECHATAI).getWechatInfo(new Subscriber<WechatEntity>() {
            @Override
