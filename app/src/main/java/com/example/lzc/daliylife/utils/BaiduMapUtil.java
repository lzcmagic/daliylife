...
public class BaiduMapUtil {
    ...
    private BaiduMapUtil() {
        //声明LocationClient类
        mLocationClient = new LocationClient(ApplWork.ApplWorkContext);
...
//        }
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            LocationEntity.setPosLat(String.valueOf(location.getLatitude()));
            LocationEntity.setPosLng(String.valueOf(location.getLongitude()));
            LocationEntity.setProvince(location.getProvince());
            sendLocation.sendLocation(LocationEntity);
            mLocationClient.stop();
            //开始跳转
            Log.i("BaiduLocationApiDem", sb.toString() + "\n" + location.getCity() + location.getProvince());
        }

        @Override
        public void onConnectHotSpotMessage(String s, int i) {
            Log.i("BaiduLocationApiDem", "s: " + s + " i: " + i);
        }
    }
